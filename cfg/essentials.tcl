...
set_property -dict [ list \
 ...
 CONFIG.PSU__GPIO_EMIO__WIDTH {[2:0]} \
...
cell xilinx.com:ip:util_vector_logic:2.0 util_vector_logic_0 {
 ...
 C_SIZE 1
  ...
  Res dp_aux_doe
  Op1 ps_0/dp_aux_data_oe_n
}

#CONNECT UART
connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_UART_1 [get_bd_intf_ports UART_CTL] [get_bd_intf_pins ps_0/UART_1]

#EMIO
connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_GPIO_0 [get_bd_intf_ports gpio_emio] [get_bd_intf_pins ps_0/GPIO_0]

#VADJ
cell xilinx.com:ip:xlconstant:1.1 vadj_auton {} {
  Dout vadj_auton
}
cell xilinx.com:ip:xlconstant:1.1 vadj_level_0 {} {
  Dout vadj_level_0
}
cell xilinx.com:ip:xlconstant:1.1 vadj_level_1 {} {
  Dout vadj_level_1
}
